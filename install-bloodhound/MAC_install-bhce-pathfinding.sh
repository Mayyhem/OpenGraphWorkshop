...
cd /tmp && \
wget https://github.com/SpecterOps/bloodhound-cli/releases/download/v0.2.0/bloodhound-cli-darwin-amd64.tar.gz && \
tar xvzf bloodhound-cli-darwin-amd64.tar.gz && \
